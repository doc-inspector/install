...
const window = { addEventListener: ()=>{}, scrollY: 0, innerHeight: 0 };
const gsap = { from: ()=>{} };
const dzIcon = { textContent: '' };
const dzTitle = { textContent: '' };
const dzSub = { textContent: '' };
